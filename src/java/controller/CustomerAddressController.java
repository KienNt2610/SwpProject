    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (service.equals("Filter")) {
                ...
                RequestDispatcher dispath = request.getRequestDispatcher("/jsp/displayCustomerAddress.jsp");
            ...
            if (service.equals("updateCustomerAddress")) {
                ...
                if (submit == null) {
                    ...
                    request.getRequestDispatcher("/update-jsp/updateCustomerAddress.jsp").forward(request, response);
                } else {
            ...
            if (service.equals("insertCustomerAddress")) {
                String submit = request.getParameter("submit");
                if (submit == null) {
                    request.getRequestDispatcher("/insert-jsp/insertCustomerAddress.jsp").forward(request, response);
                } else {
                    int CustomerId = Integer.parseInt(request.getParameter("CustomerId"));
                    String Address = request.getParameter("Address");
                    // check data
