    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (service.equals("Filter")) {
                ...
                RequestDispatcher dispath = request.getRequestDispatcher("/jsp/displayRole.jsp");
            ...
            if (service.equals("updateRole")) {
                ...
                if (submit == null) {
                    ...
                    request.getRequestDispatcher("/update-jsp/updateRole.jsp").forward(request, response);
                } else {
            ...
            if (service.equals("insertRole")) {
                String submit = request.getParameter("submit");
                if (submit == null) {
                    request.getRequestDispatcher("/insert-jsp/insertRole.jsp").forward(request, response);
                } else {
                    String RoleName = request.getParameter("RoleName");
                    // check data
                    if (RoleName.equals("")) {
