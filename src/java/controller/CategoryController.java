    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (service.equals("Filter")) {
                ...
                RequestDispatcher dispath = request.getRequestDispatcher("/jsp/displayCategory.jsp");
            ...
            if (service.equals("updateCategory")) {
                ...
                if (submit == null) {
                    ...
                    request.getRequestDispatcher("/update-jsp/updateCategory.jsp").forward(request, response);
                } else {
            ...
            if (service.equals("insertCategory")) {
                String submit = request.getParameter("submit");
                if (submit == null) {
                    request.getRequestDispatcher("/insert-jsp/insertCategory.jsp").forward(request, response);
                } else {
                    String CategoryName = request.getParameter("CategoryName");
                    // check data
                    if (CategoryName.equals("")) {
